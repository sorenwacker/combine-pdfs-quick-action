...
# Create document.wflow with proper Quick Action structure
...
<dict>
		...
		<dict>
			...
			<dict>
				...
				<dict>
					...
					<string>"$HOME/.local/bin/combine_pdfs"</string>
				...
				<key>InputUUID</key>
				<string>2C3B4D5E-6F70-8192-A3B4-C5D6E7F80910</string>
				<key>Keywords</key>
				<array>
					<string>Shell</string>
				...
				<key>OutputUUID</key>
				<string>3D4C5E6F-7081-9203-B4C5-D6E7F8091020</string>
				<key>UUID</key>
				<string>1A2B3C4D-5E6F-7081-9203-A4B5C6D7E8F9</string>
	...
	<dict>
		...
		<string>NSTouchBarFolderCopyTo</string>
